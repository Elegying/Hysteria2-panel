...
HY2PANEL_DOMAIN_USAGE_SOURCE_URL="https://raw.githubusercontent.com/Elegying/Hysteria2-panel/${PANEL_REF}/hy2panel/domain_usage.py"
...
PANEL_SHA256="d0dd0e347a1adf8d09e71e5639df124b9f8c236e5a183b2bc32cf149986c4273"
...
HY2PANEL_VERSION_SHA256="b27e21886935f8db0e2bcd26c07f60dd0f5274958b5349fee5d0b6d3d89fba9b"
...
HY2PANEL_DASHBOARD_SHA256="ba7cd30195a464be020f0a4d6a428fb5696873ef51f5a7be93284a01562b3241"
HY2PANEL_MOBILE_API_SHA256="a413d5a242a1a20b77ee84c127f192bb078b09ee0e020e817df6a0236d0048bf"
NODE_AGENT_SHA256="103e044f2371f0d428911a3a5cdcbda99ebe0cd4cb73a4b003cd8aab1a88211e"
...
verify_fresh_install_commit_payload() {
  ...
  local -a required_files=(
    ...
    '/opt/hysteria2-panel/hy2panel/domain_usage.py|root:root:644:1|1'
...
download_file "${HY2PANEL_DOMAIN_USAGE_SOURCE_URL}" "${TMP_DIR}/hy2panel/domain_usage.py"
...
printf '%s  %s\n' "${HY2PANEL_DOMAIN_USAGE_SHA256}" "${TMP_DIR}/hy2panel/domain_usage.py" | sha256sum --check --status \
  || fail "hy2panel/domain_usage.py SHA-256 校验失败"
