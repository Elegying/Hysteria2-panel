...
| 一键断连 | 在线节点自动卸载全部对接功能；失联节点可只删除中央对接关系 |
...
生产环境可以先验证固定 Release 的发布身份、文件完整性和 shell 语法，再授予 root 权限。下面示例固定到 `v0.39.16`；安装其他版本时，请同时修改 `version`：
...
- **移除节点**：在线时点击“一键断连”完成远端卸载；服务器已经失联时点击“删除对接”，只撤销中央授权；
