...
.metrics{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-bottom:16px}.metric,.card{background:var(--surface);border:1px solid var(--line);border-radius:18px;box-shadow:0 8px 28px rgba(0,0,0,.12)}.metric{padding:18px;border-top:3px solid var(--teal);min-width:0}.metric>strong{display:block;font-size:26px;margin:9px 0 3px;font-variant-numeric:tabular-nums}.metric span{color:var(--muted)}.metric-warning{display:block;color:var(--warning);font-size:12px}.metric-breakdown{display:grid;gap:3px;margin-top:9px;padding-top:8px;border-top:1px solid var(--line)}.metric-breakdown:empty{display:none}.metric-breakdown-row{display:flex;justify-content:space-between;gap:8px;min-width:0;font-size:11px}.metric-breakdown-row>span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.metric-breakdown-row>strong{color:var(--text);font-size:11px;margin:0;white-space:nowrap}.machine-stats .section-head{margin-bottom:12px}.machine-warning{margin-bottom:12px}.machine-table table{min-width:820px}.machine-table td:first-child{max-width:280px}.machine-table td:first-child strong{display:block;overflow-wrap:anywhere}.machine-kind{display:block;font-size:11px;margin-top:2px}
