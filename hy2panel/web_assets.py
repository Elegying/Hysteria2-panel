...
.actions{align-items:center;min-width:360px;gap:6px}.actions button{min-height:36px;padding:7px 10px;font-size:12px}.action-menu{position:relative}.action-menu>summary{display:inline-flex;align-items:center;justify-content:center;min-height:36px;padding:7px 10px;border:1px solid #3a506b;border-radius:9px;background:#17273b;color:#e5edf8;font-size:12px;font-weight:750;cursor:pointer;list-style:none}.action-menu>summary::-webkit-details-marker{display:none}.action-menu>summary::after{content:"";width:6px;height:6px;margin-left:8px;border-right:1.5px solid currentColor;border-bottom:1.5px solid currentColor;transform:rotate(45deg) translateY(-2px)}.action-menu[open]>summary{border-color:#6b91c3;background:#1b3048}.action-menu-panel{position:absolute;z-index:8;right:0;top:calc(100% + 7px);display:grid;gap:6px;width:160px;padding:8px;border:1px solid #3a536f;border-radius:12px;background:#101f31;box-shadow:0 18px 40px rgba(0,0,0,.48)}.action-menu-panel form,.action-menu-panel button{width:100%}
...
@media(max-width:640px){body::before{display:none}main{width:calc(100% - 24px);margin:12px auto 32px}.topbar{min-height:0;padding:18px;border-radius:18px}.topbar h1{font-size:24px;line-height:1.2}.pill{min-height:50px;text-align:left}.metrics{gap:10px}.metric{min-height:112px;padding:16px}.metric>strong{font-size:24px}.card{padding:18px;border-radius:16px}.machine-stats{padding:18px}.machine-card{padding:14px}.section-head{gap:10px}.button-row{gap:8px}.button-row button,.button-row .button{min-height:44px}.user-tools{padding:12px}.user-table{border:0}.user-table tr{grid-template-columns:minmax(0,1fr) auto;padding:14px;gap:10px 12px;border-radius:14px}.user-table td:nth-child(1){grid-column:1}.user-table td:nth-child(2){grid-column:2}.user-table td:nth-child(3){grid-column:1/-1}.user-table td:nth-child(4){grid-column:1/-1}.user-table td:nth-child(5){grid-column:1/-1}.user-table td:nth-child(6){grid-column:1/-1;margin-top:2px;padding-top:12px;border-top:1px solid #2b4058}.user-table td:nth-child(3)::before,.user-table td:nth-child(4)::before{display:block;margin-bottom:2px;color:var(--muted);font-size:10px;font-weight:700;letter-spacing:.03em}.user-table td:nth-child(3)::before{content:"在线设备"}.user-table td:nth-child(4)::before{content:"上传 / 下载"}.user-table .actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));min-width:0;gap:7px}.user-table .actions form,.user-table .actions button,.user-table .action-menu,.user-table .action-menu>summary{width:100%}.user-table .actions button,.action-menu>summary{min-height:40px;font-size:12px}.action-menu-panel{position:static;width:100%;margin-top:7px;grid-column:1/-1}.action-menu{grid-column:1/-1}.login{margin:36px auto;padding:26px}.state-page{margin:44px auto;padding:24px}.state-actions{display:grid}.dialog-shell{padding:0 18px 18px}.dialog-head{top:0;margin:0 -18px 18px;padding:18px}.dialog-head h2{font-size:21px}.operation-guides{gap:10px}.operation-guide{padding:14px}.node-enrollment-grid{padding:13px}.migration-grid .detail{padding:16px}.toast{left:12px;right:12px;bottom:12px;max-width:none}}
...
@media(prefers-contrast:more){:root{--line:#536b87;--line-strong:#7890aa;--muted:#c3cddd}.card,.metric,.machine-card,.resource,.detail,input,textarea,select{border-width:2px}}
...
@media(max-width:640px){.user-table table,.user-table tbody{display:block;width:100%;min-width:0}.user-table .action-menu{grid-column:auto}.user-table .action-menu[open]{grid-column:1/-1}}
