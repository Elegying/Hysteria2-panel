...
<form class="inline" method="post" action="/users/{id}/share" data-share-form><input type="hidden" name="csrf" value="{csrf}"><input type="hidden" name="generation" value="{generation}"><input type="hidden" name="inline" value="1"><button type="submit">分享节点</button></form>
...
<details class="action-menu"><summary>更多操作</summary><div class="action-menu-panel">
...
<form class="inline" method="post" action="/users/{id}/delete" data-confirm="确定删除用户 {name} 吗？"><input type="hidden" name="csrf" value="{csrf}"><input type="hidden" name="generation" value="{generation}"><button class="danger" type="submit">删除用户</button></form>
</div></details>
</div></td></tr>""".format(
